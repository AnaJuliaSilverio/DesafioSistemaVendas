...
public class EstoqueRepository {
    ...
    public void adicionarProduto(int quantidade, Produto produto){
    ...
    public Produto produtoExiste(Produto produto){
    ...
    public void removerProduto(Produto produto) {
        Produto pro = produtoExiste(produto.getCodigoProduto());
        if (pro != null) {
    ...
    public void adicionarDesconto(double desconto){
        ...
        for (Produto produto:produtosComDesconto.keySet()) {
    ...
    public void atualizarProdutoEstoque(int quantidade, int codigo){
        ...
        else throw new NullPointerException("Esse código não está relacionado com nenhum produto");
    }
